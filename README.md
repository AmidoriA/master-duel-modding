...
- **Link over-frame**: Link frames are supported for Auto-create and Custom OF; active `CARD_Prop` link markers are painted lit orange/red as a topmost arrow overlay after compose (inactive stay dark on `Link.png`)
