...
- **Link over-frame**: Link frames are supported for Auto-create and Custom OF; active `CARD_Prop` link markers are redrawn as a topmost arrow overlay after compose
